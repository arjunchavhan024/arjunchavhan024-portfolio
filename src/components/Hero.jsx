...
const Hero = () => {
  const counters = [
    { value: 1, suffix: "+", label: "Years of Experience (as intern)" },
    ...
    <>
      ...
      >
        <div className="flex-1 flex flex-col justify-start px-4 sm:px-8 lg:px-10">
          ...
          >
            Hi, I’m{" "}
            <span className="text-teal-500 font-bold">Arjun Chavhan</span> — a
            passionate{" "}
            <span className="text-teal-500 font-bold">
              Full Stack Developer
            </span>{" "}
            from India who enjoys turning real-world problems into scalable
            digital solutions. I thrive at the intersection of clean UI, solid
            backend logic, and meaningful user experiences.
            <br />
            <br />
            ...
            , I’ve built and deployed full-stack applications ranging from
            Airbnb-style platforms to production-grade dashboards. I love
            writing maintainable code, designing REST APIs, and working with
            modern tools like Git, Cloudinary, and Mapbox.
            <br />
            <br />
            I’ve worked as a{" "}
            <span className="text-teal-500 font-bold">
            ...
            at multiple organizations, contributing to real-world products,
            improving performance, fixing critical bugs, and collaborating with
            cross-functional teams. These experiences strengthened my
            problem-solving mindset and helped me understand how software scales
            beyond tutorials.
            <br />
            <br />
            ...
            degree, I continuously sharpen my skills through projects,
            internships, and certifications. I believe in learning by building —
            and my goal is to grow as a developer who creates impactful,
